            ...
            <div className="position-fixed">
                <div className="d-flex">
                    <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style={{width: '280px'}}>
                        ...
                        <hr/>
                        <ul className="nav nav-pills flex-column " style={{marginBottom: '290px'}}>
                            <li>
                                <a href="admin"
                                   className={`nav-link ${activePage === 'home' ? 'active' : 'text-white'}`}
                                   aria-current="page">
                            ...
                            same for all below */}
                                <a href="regUser"
                                   ...
                                   className={`nav-link ${activePage === 'regUser' ? 'active' : 'text-white'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16"
                                         height="16">
                                        <path
                            ...
                            <li>
                                <a href="regDriver"
                                   className={`nav-link ${activePage === 'regDriver' ? 'active' : 'text-white'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16"
                                         height="16">
                                        <path
                                            d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0Zm-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
                            ...
                            <li>
                                <a href="updtUser"
                                   className={`nav-link ${activePage === 'updtUser' ? 'active' : 'text-white'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16"
                                         height="16">
                                        <path
                            ...
                            <li>
                                <a href="updtDriver"
                                   className={`nav-link ${activePage === 'updtDriver' ? 'active' : 'text-white'}`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16"
                                         height="16">
                                        <path
                                            d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 8c0 1 1 1 1 1h5.256A4.493 4.493 0 0 1 8 12.5a4.49 4.49 0 0 1 1.544-3.393C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4Zm9.886-3.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382l.045-.148ZM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0Z"/>
                            ...
                            <li>
                                {/*<a href="setPickup"*/}
                                {/*   className={`nav-link ${activePage === 'setPickup' ? 'active' : 'text-white'}`}>*/}
                                {/*    <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16"*/}
                                {/*         height="16">*/}
                                {/*        <path*/}
