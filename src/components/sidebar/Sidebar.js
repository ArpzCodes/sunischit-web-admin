            ...
            <div className="d-flex">
                <div className="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary" style={{ width: '280px' }}>
                    <a href="/" className="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                        <img className="bi pe-none me-2" src="https://picsum.photos/200/300" width="40" height="32" alt="Logo" />
                    ...
                    <ul className="nav nav-pills flex-column mb-auto" style={{ marginBottom: '20px' }}>
                        <li className="nav-item">
                            <a href="#" className="nav-link active" aria-current="page">
                                <svg xmlns="http://www.w3.org/2000/svg" className="bi pe-none me-2" width="16" height="16">
